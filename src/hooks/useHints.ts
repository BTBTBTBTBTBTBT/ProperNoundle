...
import { Guess, TileState, Puzzle } from '../types/game';
import { normalizeString } from '../utils/gameLogic';
import { fetchWikipediaHint } from '../utils/wikipedia';
...
export function useHints() {
  ...
  const restoreHints = useCallback((data: Partial<HintState>) => {
